...
<div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>">
	<div class="bx-filter-section container-fluid">
		<div class="row"><div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-title">Стоимость</div></div>
						...
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box bx-active">
							...
							<div class="bx-filter-block" data-role="bx_filter_block">
								<div class="row bx-filter-parameters-box-container">
                                    ...
                                    <div class="filter-price">
									<div class="filter-price-range" id="range">
										<div class="bx-ui-slider-track" id="drag_track_<?=$key?>">
											<div class="ui-slider-range ui-corner-all ui-widget-header" style="left: 0;right: 0;" id="colorUnavailableActive_<?=$key?>"></div>
											<div class="ui-slider-range ui-corner-all ui-widget-header" style="left: 0;right: 0;" id="colorAvailableInactive_<?=$key?>"></div>
											<div class="ui-slider-range ui-corner-all ui-widget-header"  style="left: 0;right: 0;" id="colorAvailableActive_<?=$key?>"></div>
											<div class="bx-ui-slider-range" id="drag_tracker_<?=$key?>"  style="left: 0%; right: 0%;">
												<a class="ui-slider-handle ui-corner-all ui-state-default left"  style="left:0;" href="javascript:void(0)" id="left_slider_<?=$key?>"></a>
												<a class="ui-slider-handle ui-corner-all ui-state-default right" style="right:0;" href="javascript:void(0)" id="right_slider_<?=$key?>"></a>
											</div>
										</div>
									</div>
								</div>
